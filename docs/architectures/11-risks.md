...
| Frontend Core only Partial | `GeneratedForm`, `WorkflowActionBar`, a dedicated `FieldRenderer`, permission-aware UI state, and table virtualization aren't built — this repo's own convention of browser-verifying UI changes can't fully apply yet | Continuing Phase 6 |
