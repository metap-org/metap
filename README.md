...
The backend moved from TypeScript to Rust on 2026-08-07 — see `docs/architectures/09-adr/00-index.md` for the decision record, and `docs/roadmap.md`'s Phase 12 for status (both moved to `../metap-docs`, see "Docs" below).
...
- Architecture Decisions: `docs/architectures/09-adr/00-index.md` — decision log, including why the backend moved to Rust
