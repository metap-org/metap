...
const en = {
  ...
  admin: {
    ...
    policies: {
      ...
      subject: "Subject",
      condition: "Condition",
      conditionDescription: "Optional JSON PolicyCondition (e.g. {\"attribute\":\"status\",\"op\":\"eq\",\"value\":\"open\"}).",
    },
    cronJobs: {
      title: "Cron Jobs",
      ...
      cronExprDescription: "6-field cron syntax with seconds: sec min hour day month weekday (e.g. 0 */15 * * * * for every 15 minutes).",
      timezone: "Timezone",
...
const vi = {
  ...
  admin: {
    ...
    policies: {
      ...
      subject: "Subject",
      condition: "Điều kiện",
      conditionDescription: "JSON PolicyCondition, không bắt buộc (vd: {\"attribute\":\"status\",\"op\":\"eq\",\"value\":\"open\"}).",
    },
    cronJobs: {
      title: "Cron Jobs",
      ...
      cronExprDescription: "Cú pháp cron 6 trường có seconds: sec min hour day month weekday (vd: 0 */15 * * * * cho mỗi 15 phút).",
      timezone: "Múi giờ",
